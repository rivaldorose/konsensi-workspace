    ...
    <aside className="w-[240px] flex-shrink-0 bg-white border-r border-[#ecf3e7] flex flex-col h-full hidden md:flex overflow-y-auto">
      <div className="flex-1 px-3 py-6 space-y-8">
        ...
        <div>
          ...
          <div className="space-y-1">
            {favorites.map((fav) => (
              <a
                key={fav.id}
                className="flex items-center gap-3 rounded-lg px-3 py-2 text-[#131b0d] dark:text-white hover:bg-[#f7f8f6] dark:hover:bg-[#2a3820] group transition-colors cursor-pointer"
        ...
        <div>
          ...
          <div className="space-y-1">
            {recentDocs.slice(0, 3).map((file) => (
              <a
                key={file.id}
                className="flex items-center gap-3 rounded-lg px-3 py-2 text-[#131b0d] dark:text-white hover:bg-[#f7f8f6] dark:hover:bg-[#2a3820] group transition-colors cursor-pointer"
                onClick={() => router.push(`/docs/${file.id}`)}
              >
                <svg className="w-5 h-5 text-gray-400 dark:text-gray-500 group-hover:text-primary" fill="currentColor" viewBox="0 0 20 20">
          ...
          <div className="space-y-1">
            <a
              className={`flex items-center gap-3 rounded-lg px-3 py-2 ${
                selectedFolder === 'all' 
                  ? 'bg-primary/10 text-[#131b0d] dark:text-white border border-primary/20 font-medium' 
                  : 'text-[#131b0d] dark:text-white hover:bg-[#f7f8f6] dark:hover:bg-[#2a3820]'
            ...
            <button 
              className="flex items-center gap-3 rounded-lg px-3 py-2 text-gray-500 dark:text-gray-400 hover:text-primary hover:bg-[#f7f8f6] dark:hover:bg-[#2a3820] w-full text-left mt-2 group transition-colors"
      ...
      <div className="p-4 border-t border-[#ecf3e7] dark:border-[#334025] mt-auto">
        <button className="flex items-center gap-3 w-full text-left hover:bg-[#f7f8f6] dark:hover:bg-[#2a3820] p-2 rounded-lg transition-colors">
